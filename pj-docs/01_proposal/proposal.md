...
- MVPでは課金機能を実装せず、完成後に自社で運用実験を行い、検証結果を基に導入を進める。
...
| MVP開発 | 0.5日 | 写真アップロード、AI推定、カテゴリ別表示、手動修正 |
| 確認・検証 | 0.5日 | ZIP出力、評価用写真での分類確認 |
| 自社運用実験 | MVP完了後 | 自社の物件写真で分類精度、処理時間、運用負荷を測定し、導入判断に用いる |
...
| v0.5 | 2026/09/15 | プラン表示、MVP期間、自社運用実験後の導入方針を更新 | 渡邉極 |
| v0.6 | 2026/09/15 | MVPのスケジュールを0.5日単位へ簡略化 | 渡邉極 |